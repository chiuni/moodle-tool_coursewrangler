...
class activity_last_modified implements rule_interface
{
    ...
    function __construct(int $activity_lastmodified, int $course_timecreated, int $time_unit)
    {
        ...
        $components = [
            'activity_lastmodified' => $activity_lastmodified,
    ...
    {
        return ($components['activity_lastmodified'] != $components['course_timecreated']);
    }
    function calculate_score(array $components, array $settings = []): float
    {
        return (($components['course_timecreated'] - $components['activity_lastmodified']) / $settings['time_unit']);
    }
}
